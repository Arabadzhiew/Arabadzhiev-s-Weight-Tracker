...
* MainWindow.java: This class is the entry point of the program. It is also the biggest of all classes, consisting of around 90% of all the code. It is responsible for displaying the main window, all of it's nodes and it is also responsible for all of pretty much all of the program's logic. ;
